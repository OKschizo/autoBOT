...
class WebsiteScraper:
    ...
    def extract_pool_data(self, page):
        ...
        try:
            ...
            print(f"  Error extracting pool data: {e}")
    ...
    def discover_pool_pages(self, page, url):
        ...
        try:
            ...
            if pool_urls:
                print(f"  Discovered {len(pool_urls)} pool pages to scrape")
    ...
    def scrape_page(self, page, url):
        ...
        try:
            ...
            if data:
                ...
                print(f"  [OK] Extracted: {data['title'][:60]}")
    ...
    def scrape_all(self, start_urls=None):
        ...
        with sync_playwright() as p:
            ...
            while to_visit:
                ...
                print(f"Progress: {visited_count} pages scraped, {len(to_visit)} in queue")
            
            browser.close()
        
        print(f"\n[OK] Completed! Scraped {len(self.scraped_pages)} pages")
    ...
    def save_to_markdown(self):
        ...
        print(f"Saved {len(self.scraped_pages)} markdown files to {md_dir}")
...
def main():
    ...
    print("\n" + "="*60)
    print("Summary:")
    print(f"Total pages scraped: {len(scraper.scraped_pages)}")
    
    # Count pages with live data
    live_data_count = sum(1 for p in scraper.scraped_pages if p.get('pool_data'))
    print(f"Pages with live data: {live_data_count}")
    print("="*60)
