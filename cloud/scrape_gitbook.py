...
class GitBookScraper:
    ...
    def scrape_page(self, url):
        ...
        try:
            ...
            if content and content['content']:
                ...
                print(f"  [OK] Extracted: {content['title'][:50]}", flush=True)
            ...
            print(f"  [ERROR] Error scraping {url}: {str(e)}", flush=True)
            return []
    ...
    def scrape_all(self, max_pages=None):
        ...
        while to_visit and (max_pages is None or pages_scraped < max_pages):
            ...
            print(f"Progress: {pages_scraped} pages scraped, {len(to_visit)} in queue", flush=True)
